                        ...
                        ->schema([
                            ...
                            Forms\Components\Placeholder::make('segurado_id')
                                ...
                                ->content(function (Get $get) {
                                    ...
                                    $apolice = Apolice::with(['segurado.seguradoPf', 'segurado.seguradoPj'])->find($apoliceId);
                            ...
                            Forms\Components\Placeholder::make('produto_id')
                                ...
                                ->content(function (Get $get) {
                                    ...
                                    $apolice = Apolice::with(['cotacao.produto'])->find($apoliceId);
                            ...
                            Forms\Components\DateTimePicker::make('data_hora_ocorrencia')
                                ...
                                ->minDate(function (Get $get) {
                                    ...
                                    $apolice = Apolice::find($apoliceId);
                ...
                Forms\Components\Section::make('Controle Financeiro')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('valor_pago')
                                ...
                                ->numeric()
                                ->prefix('R$')
                                ->disabled(fn (Get $get) => ! (auth()->user()->hasRole('Financeiro') && $get('status') === 'Aprovado'))
                                ->dehydrated(),
                    ]),
        ...
        return $table
            ...
            ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('assumir')
                        ...
                        ->color('success')
                        ->visible(
                            fn (Model $record) => auth()->user()->hasAnyRole(['Analista de Sinistros', 'Gestor de Filial']) &&
                    ...
                    Tables\Actions\Action::make('aprovar')
                        ...
                        ->color('success')
                        ->visible(
                            fn (Model $record) => in_array($record->status, ['Em análise', 'Em perícia', 'Aguardando Documentação']) &&
                    ...
                    Tables\Actions\Action::make('aprovar_gestor')
                        ...
                        ->color('warning')
                        ->visible(
                            fn (Model $record) => $record->status === 'Aguardando Gestor' &&
